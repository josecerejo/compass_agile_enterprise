...
Gem::Specification.new do |s|
  ...
  s.add_dependency "erp_app", "~> 3.0"
  s.add_dependency "erp_txns_and_accts", "~> 3.0"
  s.add_dependency "erp_agreements", "~> 3.0"
  s.add_dependency "erp_products", "~> 3.0"
  s.add_dependency "erp_orders", "~> 3.0"
  s.add_dependency "erp_commerce", "~> 3.0"
