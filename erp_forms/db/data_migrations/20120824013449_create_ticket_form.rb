class CreateTicketForm
  ...
  def self.up
    ticket = DynamicFormModel.find_or_create_by_model_name(:model_name => 'Ticket')

    if DynamicForm.find_by_internal_identifier('ticket').nil?
      fields = []
