...
== TODO
Redefine search fields on the fly 
  when a form changes solr definition must reload on the fly
  currently passenger must be restarted when a form changes for solr to be updated
  https://groups.google.com/forum/?fromgroups=#!topic/ruby-sunspot/0oewzoys_vg
